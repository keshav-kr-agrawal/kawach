...
export function buildSimReports() {
  ...
  return [
    ...
    r('POLICE', 'Stolen Vehicle Tracking: Mahindra Thar KA-04-MN-8821', 'ANPR camera flagged suspect getaway vehicle at Electronic City Toll Gate.', { priority: 'HIGH', hoursAgo: 78, urgency: 78 }),
