      ...
      <div style={{
        ...
        <div style={{
          ...
          <div className="glass-panel" style={{
            ...
            <ShieldCheck size={16} style={{ color: '#fffc00' }} />
          ...
          <div style={{
            ...
            <div style={{
              ...
              {videoUrl ? (
                ...
                <div style={{ height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#fffc00' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                  ...
                  <input 
                    ...
                    style={{ flex: 1, accentColor: '#fffc00' }}
                  />
                </div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '10px', marginBottom: '14px' }}>
              ...
              <div style={{
                ...
                <input 
                  ...
                  style={{ accentColor: '#fffc00', width: '18px', height: '18px', cursor: 'pointer' }}
                />
              </div>
            </div>
            ...
            <div style={{ display: 'flex', gap: '10px', marginTop: 'auto', paddingBottom: '10px' }}>
              ...
              <button
                ...
                style={{
                  ...
                  borderRadius: '12px',
                  border: 'none',
                  backgroundColor: emergencyOverride ? '#ff3b30' : '#fffc00',
                  color: '#000000',
                  fontWeight: '800',
                  fontSize: '12px',
                  cursor: 'pointer',
                  boxShadow: `0 4px 12px ${emergencyOverride ? 'rgba(255, 59, 48, 0.2)' : 'rgba(255, 252, 0, 0.25)'}`,
                  display: 'flex',
                  alignItems: 'center',
                  justifyContent: 'center',
                  gap: '4px'
